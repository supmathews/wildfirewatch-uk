...
- land-cover source: committed cache-only OSM coarse tag classification
...
- The sample remains tiny: 5 usable positives.
- Public Overpass endpoints can rate-limit; prefer cache-only mode for deterministic reports.
